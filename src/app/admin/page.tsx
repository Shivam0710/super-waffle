  ...
  return (
    <div className='bg-white h-full h-screen p-10 lg:p-24 grow w-screen'>
        ...
        <section className='flex align-middle gap-10'>
            ...
            <a href="/admin/subcategory" className='bg-slate-600 shadow-lg w-1/6 rounded-lg h-48 flex align-middle justify-center self-center items-center cursor-pointer'>
                <p> Subcategory </p>
            </a>
            <a href="/admin/blog" className='bg-slate-600 shadow-lg w-1/6 rounded-lg h-48 flex align-middle justify-center self-center items-center cursor-pointer'>
                <p> Blog </p>
            </a>
        </section>
    </div>
